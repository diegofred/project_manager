...
RSpec.describe Api::V1::ProjectsController, type: :controller do
  ...
  describe 'PUT #update' do
    ...
    context 'with invalid params' do
      ...
      it 'access to unauthorized object' do
        another_user = FactoryBot.create(:user)
        other_project = FactoryBot.create(:project, user_id: another_user.id)
        put :update, params: { id: other_project.to_param, project: valid_attributes }
  ...
  describe 'DELETE #destroy' do
    ...
    it 'destroys a unauthorized object' do
      another_user = FactoryBot.create(:user)
      other_project = FactoryBot.create(:project, user_id: another_user.id)
      expect do
        delete :destroy, params: { id: other_project.to_param }
      end.to change(Project, :count).by(0)
      expect(response).to have_http_status(:bad_request)
    end
